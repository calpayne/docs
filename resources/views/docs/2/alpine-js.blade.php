...
Let's create a contrived example where when a user clicks a button a property called `$foo` is set to `bar`, and when a user clicks another button, `$foo` is set to `baz`.
